...
fn main() {
    ...
    let btc_info = manager.assets.get(&symbol_info.base_asset_id).expect("Asset not found");
    ...
    println!("Price Decimals: {}, Qty Display Decimals: {}", price_decimals, qty_display_decimals);
    println!();
    ...
    println!("With 8 decimals, max representable value = {}", 
