...
mod tests {
    ...
    #[test]
    fn test_python_signature_compatibility() {
        // Test with exact values from Python to verify cross-language compatibility
        // These values were generated by scripts/test_api_auth.py
        let public_key_hex = "d75a980182b10ab7d54bfed3c964073a0ee172f3daa62325af021a68f707511a";
        let signature_hex = "83a769df925ddbf283d50fc8cca68eb3c82118b6940594b408f01ae16124dcc153acb9dcca5272573ea8ba6aa442eda8e9228dee2163674df225c5c946d40200";
        let payload = "AK_D4735E3A265E16EE1766416500000GET/api/v1/private/orders";
        ...
        let result = verify_ed25519(&public_key, payload.as_bytes(), &signature);
        assert!(result, "Python-generated signature should verify in Rust");
    }
}
